...
public class GoblinStoreActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_init:
                new InputTextDialog(this, "storeType(1地精商店，2竞技场商店)") {
                    @Override
                    public void sendText(String text) {
                        try {
                            ...
                            SendUtils.sendMsg(SGMainProto.E_MSG_ID.MsgID_Store_InitInfo_VALUE, request1.build().toByteArray());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
                ...
                new InputTextDialog(this, "storeType(1地精商店，2竞技场商店)") {
                    ...
                    public void sendText(String text) {
                        try {
                            ...
                            SendUtils.sendMsg(SGMainProto.E_MSG_ID.MsgID_Store_InitInfo_VALUE, request2.build().toByteArray());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
                ...
                new InputTextDialog(this, "storeType;goodsId;count") {
                    ...
                    public void sendText(String text) {
                        try {
                            ...
                            SendUtils.sendMsg(SGMainProto.E_MSG_ID.MsgID_Store_BuyGoods_VALUE, request.build().toByteArray());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
