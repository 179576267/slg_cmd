            ...
            case R.id.btn_card_rebirth:
                new InputTextDialog(this, "carId") {
                    ...
                    public void sendText(String text) {
                        ...
                        SendUtils.sendMsg(SGMainProto.E_MSG_ID.MsgID_Bag_RebirthCard_VALUE, request.build().toByteArray());
                    }
                }.show();
                break;
            case R.id.btn_preview_resolve_card:
                SendUtils.sendMsg(SGMainProto.E_MSG_ID.MsgID_Bag_ResolveCardPreview_VALUE, null);
                break;
            case R.id.btn_card_fragment_resolve:
                new InputTextDialog(this, "cardFragmentId") {
                    ...
                    public void sendText(String text) {
                        ...
                        SendUtils.sendMsg(SGMainProto.E_MSG_ID.MsgID_Bag_SoulResolve_VALUE, request.build().toByteArray());
                    }
                }.show();
                break;
            ...
            case R.id.btn_equip_resolve:
                new InputTextDialog(this, "equipId") {
                    ...
                    public void sendText(String text) {
                        ...
                        SendUtils.sendMsg(SGMainProto.E_MSG_ID.MsgID_Bag_EquipResolve_VALUE, request.build().toByteArray());
                    }
                }.show();
                break;
            default:
