...
package com.wzf.yjdemo.activity;
...
import com.wzf.yjdemo.view.BaseView;
import com.wzf.yjdemo.view.ChargeView;
import com.wzf.yjdemo.view.UserLoginView;
...
public class DemoMainActivity extends Activity implements BaseView.ChangeViewListener{
	...
	private void initSDK() {
		...
		SFOnlineHelper.onCreate(this, new SFOnlineInitListener() {
			@Override
			public void onResponse(String tag, String s1) {
	...
	public void onBackPressed() {
		...
		SFOnlineHelper.exit(this, new SFOnlineExitListener() {
			...
			public void onNoExiterProvide() {
				Builder builder = new Builder(DemoMainActivity.this);
